...
void jubjub_field_pow_t(jubjub_fq r, const jubjub_fq a) {
  cx_math_powm_no_throw(r, a, JUBJUB_FQ_SQRT_T, JUBJUB_FIELD_BYTES,
                        JUBJUB_FQ_MODULUS_BYTES, JUBJUB_FIELD_BYTES);
}

void jubjub_field_negate(jubjub_fq r, const jubjub_fq a) {
  cx_math_subm_no_throw(r, JUBJUB_FQ_ZERO, a, JUBJUB_FQ_MODULUS_BYTES,
                        JUBJUB_FIELD_BYTES);
}
...
void jubjub_extendedpoint_cmov(jubjub_extendedpoint *r, jubjub_extendedpoint p,
                               unsigned int bit) {
...
void jubjub_extendedpoint_normalize(jubjub_extendedpoint *r,
...
void jubjub_extendedpoint_double(jubjub_extendedpoint *r,
                                 jubjub_extendedpoint p) {
...
void jubjub_extendedpoint_scalarmult(jubjub_extendedpoint *r,
                                     jubjub_fr scalar) {
