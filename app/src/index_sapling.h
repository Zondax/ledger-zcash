...
#define T_IN_TX_LEN                                                            \
  74 // size of tx_in encoded as in bitcoin. The same across all tx versions
#define SPEND_OLD_TX_LEN 40
#define SPEND_TX_LEN                                                           \
  320 // cv (32) + anchor (32) + nullifier (32) + rk (32) + zkproof (192)
...
#define INDEX_OUTPUT_ENC_AEAD_TAG                                              \
  96 + 564 // contents of the encrypted memo field
