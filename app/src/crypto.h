...
zxerr_t crypto_fillAddress_secp256k1(uint8_t *buffer, uint16_t bufferLen,
                                     uint16_t *replyLen);
...
zxerr_t crypto_checkspend_sapling(uint8_t *buffer, uint16_t bufferLen,
                                  const uint8_t *spenddata,
                                  uint16_t spenddatalen,
...
uint16_t crypto_key_exchange(uint8_t *buffer, uint16_t bufferLen,
